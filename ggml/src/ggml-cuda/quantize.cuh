...
// [TAG_MMSB] [TAG_SMALLB] quantize_mmq_q8_1_cuda launched with PDL (the kernel triggers the dependent launch first
// thing); used by the small-batch matmul (mmsb.cu) only. MMQ keeps quantize_mmq_q8_1_cuda.
