...
static const struct ggml_type_traits type_traits[GGML_TYPE_COUNT] = {
    ...
    // [TAG_TURBO5P] parsed by -ctk / -ctv as "turbo5p".
    [GGML_TYPE_TURBO5P_0] = {
        .type_name                = "turbo5p",
        .blck_size                = QK_TURBO5P,
        .type_size                = sizeof(block_turbo5p_0),
        .is_quantized             = true,
...
struct ggml_tensor * ggml_turbot_set_rows(
    ...
    // bytes 0..23 of op_params are zero, the turbot params go at byte GGML_TURBOT_OP_PARAMS_OFFSET (24)
...
void ggml_flash_attn_ext_set_turbot(
    ...
    // writes op_params bytes 24..47 only: scale, max_bias, softcap, prec and n_kv_max (bytes 0..19) are untouched
